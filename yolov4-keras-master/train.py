...
from tensorflow.compat.v1.keras.callbacks import ( EarlyStopping, LearningRateScheduler,
                              TensorBoard)
from tensorflow.compat.v1.keras.layers import Conv2D, Dense, DepthwiseConv2D
...
if __name__ == "__main__":
    ...
    classes_path = r"C:\Users\USER\Downloads\craig\Python_Package\yolo\yolov4-keras-master\model_data\voc_classes.txt"
    #---------------------------------------------------------------------#
    #   anchors_path    代表先验框对应的txt文件，一般不修改。
    #   anchors_mask    用于帮助代码找到对应的先验框，一般不修改。
    #---------------------------------------------------------------------#
    anchors_path    = 'model_data/yolo_anchors.txt'
    anchors_path =  r"C:\Users\USER\Downloads\craig\Python_Package\yolo\yolov4-keras-master\model_data\yolo_anchors.txt"
    ...
    model_path      = r"C:\Users\USER\Downloads\craig\Python_Package\yolo\yolov4-keras-master\model_data\yolo4_weight.h5"
    #------------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    save_dir            = 'logs'
    save_dir            = r'C:\Users\USER\Downloads\craig\Python_Package\yolo\yolov4-keras-master\logs'
    #------------------------------------------------------------------#
    ...
    if True:
        ...
        callbacks = []
        callbacks = [logging, loss_history, checkpoint, checkpoint_last, checkpoint_best, eval_callback]
        my_callbacks = [
